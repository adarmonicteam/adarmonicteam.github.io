...
We then decided to put our topic classifier at use and filtered state-specific tweets via topic
Below are the maps for tweets classified with the topic of black support and for Trump support.

{% include trump_support.html %}

{% include black_support.html %}
